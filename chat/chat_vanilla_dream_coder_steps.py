"""
原生 Dream-Coder 对话脚本 —— 流式逐步扩散可视化版本（基于 chat_vanilla_dream_coder.py）。
使用模型：Dream-org/Dream-Coder-v0-Instruct-7B。

与 chat_vanilla_dream_coder.py 的唯一区别：利用 diffusion_generate 的
...
print("\n" + "=" * 80)
print(f"Vanilla Dream-Coder Chat (streaming steps, model = {MODEL_PATH}). Type 'quit' or 'exit' to end.")
print("=" * 80)
